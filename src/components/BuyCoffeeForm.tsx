...
const BuyCoffeeForm: React.FC<BuyCoffeeFormProps> = ({ onSubmit }) => {
  ...
  const handleSubmit = async(e: React.FormEvent) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      ...
      const contractAddress = "0x3d3212874efB3E770597716d72518c9649FBDAA6";
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              onBlur={handleBlur}
              placeholder="Thank you for solving our painpoints.!"
              rows={3}
              className={`w-full px-4 py-2 rounded-lg border ${
          ...
          <div>
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <span className="mx-2 text-amber-700">STT</span>
              </div>
              <input
                type="number"
                id="amount"
